...
function Navbar() {
  const [open, setOpen] = useState(false);
    return (
        <nav>
            <div className={style.icon}><a href='#Home'><span><FontAwesomeIcon icon={faHome} title="Home" /></span></a></div>
            <div className={style.mobile}>
                <div className={`${style.mobileIcon} ${style.icontop} `}><a href='#Home'><img src={img} alt="" /></a></div>
            ...
            <div className={style.icon}><a href='#Video'><span><FontAwesomeIcon icon={faYoutube} title="YouTube"/></span></a></div>
        </nav>
    )
}
