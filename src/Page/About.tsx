...
const EventList = [
  {
    ...
    content: `小祥是一位熱愛玩遊戲的大學生，尤其喜歡在課餘時間沉浸在Steam上的各種遊戲世界中。某天下午，他正在瀏覽社群網站，突然看到一則貼文吸引了他的目光——「限時免費領取《XXX》Steam遊戲，只送今天！」下方還附了一個看起來非常正常的連結，以及幾張遊戲畫面截圖和留言區一堆「太讚了！真的領到了！」的回應。
...
芭樂愣住了，手機完全無法操作，就連開機畫面都被攔截。他嘗試重開、進入安全模式，但都被病毒攔住。這時，他腦中閃過昨天剛拍完的一堆重要報告影片，還有多年來累積的照片與聊天紀錄，全部都在手機裡。`,
    ...
    title: '企鵝的一封通知信：揭開盜用事件',
    content: `企鵝是一位喜歡分享日常生活的社群重度使用者，IG 上記錄了他的穿搭、旅遊、美食，還有許多與好友的點滴。某天下午，他正準備打開 YouTube 看影片放鬆一下，突然手機跳出一封 Email 通知：

「你的 Instagram 電子郵件地址已被變更，如果這不是你本人操作，請立即點擊此處還原變更。」

他瞬間愣住了，因為他根本沒有動過 IG 帳號的設定。驚慌之下，他立刻打開 Instagram App，卻發現自己已經登不進帳號了。所有熟悉的相片、限時動態、追蹤者全都不見，只剩下冰冷的「帳號不存在」畫面。

他試著透過「忘記密碼」功能找回帳號，但駭客已經更改了綁定的 Email 和電話號碼。這讓他意識到，自己的 IG 已被完全接管。

回想起幾天前，他曾經點過一個 IG 私訊連結，內容寫著「你被標記在這個影片裡」，他出於好奇點了進去並輸入過帳密。那時候看起來什麼事也沒發生，沒想到現在帳號竟然被盜了。

企鵝非常懊惱，因為那個帳號累積了多年心血。不僅如此，駭客還假冒他身分對朋友進行詐騙，讓他倍感羞愧。他後來透過 IG 客服申訴程序、驗證身份，經過幾天才艱難地拿回帳號。`,
